...
// get current date and search for corresponding clue
$currentDate = date('Y/m/d');
$result = $db->query("SELECT * FROM crypticClue WHERE clueDate = '". $currentDate ."'");
$clues = mysqli_fetch_array($result, MYSQLI_ASSOC);
?>
	          ...
	          <div id="clueback">
	             ...
	             <div class="row">	        
	                 ...
	                 <div class="col-md-4 col-xs-6 clueCenter">			              			    			  
						 ...
						 <!-- Multiplier for empty stars is  $multiplier 5 - difficulty rating from DB -->
						 <?php $multiplier = 5 - $clues['difficulty'] ?>
	                     <?php echo str_repeat('<span class="glyphicon glyphicon-star"></span> ',$clues['difficulty']); ?>
	              ...
	              <div class="row">	   
	                  <div class="col-md-12 col-xs-12 clueCenter">
	                      <h4><?php echo $clues['clueText']; ?></h4>
			              <span id="hint"><b>Hint:</b> <?php echo $clues['clueHint']; ?></span>
	                  </div>
	              </div>
	             <div class="row">
	                 <div class="col-md-3">
